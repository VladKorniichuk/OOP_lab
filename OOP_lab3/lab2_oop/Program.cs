...
using lab2_oop.Constructions.IndustrialHalls;
using lab2_oop.Constructions.ResidentalBuildings;
...
var residental = new ResidentalBuildings();
var hall = new IndustrialHalls();
